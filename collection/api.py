...
class CollectionAuthorization(Authorization):
    ...
    def read_list(self, object_list, bundle):
        ...
        user_objects = get_objects_for_user(user, ['collection.view_collection'], object_list)
    ...
    def delete_list(self, object_list, bundle):
        ...
        """
        raise Unauthorized("You do not have permission to delete this collection.")
    ...
    def update_detail(self, object_list, bundle):
        ...
        if user.has_perm('collection.update_collection', original):
            ...
            # it is a fairly complex setup - locked prevents certain things, but not
            # others etc.
            # this isn't so much an authorisation issue but a model issue however
            True
        else:
