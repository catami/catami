...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field generic_images on 'Collection'
        db.create_table('collection_collection_generic_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['collection.collection'], null=False)),
            ('genericimage', models.ForeignKey(orm['catamidb.genericimage'], null=False))
        ))
        db.create_unique('collection_collection_generic_images', ['collection_id', 'genericimage_id'])


    def backwards(self, orm):
        # Removing M2M table for field generic_images on 'Collection'
        db.delete_table('collection_collection_generic_images')
    ...
    models = {
        ...
        'collection.collection': {
            ...
            'generic_images': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'collections'", 'symmetrical': 'False', 'to': "orm['catamidb.GenericImage']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
