...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('collection_collection', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.MyProfile'])),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collection.Collection'], blank=True)),
        ))
    ...
    models = {
        ...
        'collection.collection': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.MyProfile']"}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['collection.Collection']", 'blank': 'True'})
        },
