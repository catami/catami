...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('collection_collection', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Collection.owner'
        db.alter_column('collection_collection', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.MyProfile']))
