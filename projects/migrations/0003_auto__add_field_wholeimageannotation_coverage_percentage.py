...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WholeImageAnnotation.coverage_percentage'
        db.add_column('projects_wholeimageannotation', 'coverage_percentage',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WholeImageAnnotation.coverage_percentage'
        db.delete_column('projects_wholeimageannotation', 'coverage_percentage')
