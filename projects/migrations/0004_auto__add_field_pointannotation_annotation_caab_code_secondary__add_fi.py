...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PointAnnotation.annotation_caab_code_secondary'
        db.add_column('projects_pointannotation', 'annotation_caab_code_secondary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'PointAnnotation.qualifier_short_name_secondary'
        db.add_column('projects_pointannotation', 'qualifier_short_name_secondary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'WholeImageAnnotation.annotation_caab_code_secondary'
        db.add_column('projects_wholeimageannotation', 'annotation_caab_code_secondary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'WholeImageAnnotation.qualifier_short_name_secondary'
        db.add_column('projects_wholeimageannotation', 'qualifier_short_name_secondary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PointAnnotation.annotation_caab_code_secondary'
        db.delete_column('projects_pointannotation', 'annotation_caab_code_secondary')

        # Deleting field 'PointAnnotation.qualifier_short_name_secondary'
        db.delete_column('projects_pointannotation', 'qualifier_short_name_secondary')

        # Deleting field 'WholeImageAnnotation.annotation_caab_code_secondary'
        db.delete_column('projects_wholeimageannotation', 'annotation_caab_code_secondary')

        # Deleting field 'WholeImageAnnotation.qualifier_short_name_secondary'
        db.delete_column('projects_wholeimageannotation', 'qualifier_short_name_secondary')
    ...
    models = {
        ...
        'projects.pointannotation': {
            ...
            'annotation_caab_code_secondary': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'qualifier_short_name_secondary': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        'projects.wholeimageannotation': {
            ...
            'annotation_caab_code_secondary': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'annotation_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.AnnotationSet']"}),
            'coverage_percentage': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catamidb.Image']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'qualifier_short_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
