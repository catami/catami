...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catamidb_measurements', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.GenericImage'])),
        ...
        db.create_table('catamidb_genericimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('catamidb', ['GenericImage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('catamidb_genericimage')
