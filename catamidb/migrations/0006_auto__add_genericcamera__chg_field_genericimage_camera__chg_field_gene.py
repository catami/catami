...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericCamera'
        db.create_table('catamidb_genericcamera', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deployment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.GenericDeployment'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('angle', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('catamidb', ['GenericCamera'])


        # Changing field 'GenericImage.camera'
        db.alter_column('catamidb_genericimage', 'camera_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.GenericCamera']))

        # Changing field 'GenericImage.deployment'
        db.alter_column('catamidb_genericimage', 'deployment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.GenericDeployment']))

    def backwards(self, orm):
        # Deleting model 'GenericCamera'
        db.delete_table('catamidb_genericcamera')


        # Changing field 'GenericImage.camera'
        db.alter_column('catamidb_genericimage', 'camera_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.Camera']))

        # Changing field 'GenericImage.deployment'
        db.alter_column('catamidb_genericimage', 'deployment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.Deployment']))
    ...
    models = {
        ...
        'catamidb.genericcamera': {
            'Meta': {'object_name': 'GenericCamera'},
            'angle': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'catamidb.genericimage': {
            ...
            'camera': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catamidb.GenericCamera']"}),
