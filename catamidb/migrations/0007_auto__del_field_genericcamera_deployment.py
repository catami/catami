...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GenericCamera.deployment'
        db.delete_column('catamidb_genericcamera', 'deployment_id')


    def backwards(self, orm):
        # Adding field 'GenericCamera.deployment'
        db.add_column('catamidb_genericcamera', 'deployment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catamidb.GenericDeployment']),
                      keep_default=False)
