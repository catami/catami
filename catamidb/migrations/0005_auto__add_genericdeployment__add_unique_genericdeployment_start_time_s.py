...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericDeployment'
        db.create_table('catamidb_genericdeployment', (
        ...
        db.send_create_signal('catamidb', ['GenericDeployment'])

        # Adding unique constraint on 'GenericDeployment', fields ['start_time_stamp', 'short_name']
        db.create_unique('catamidb_genericdeployment', ['start_time_stamp', 'short_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'GenericDeployment', fields ['start_time_stamp', 'short_name']
        db.delete_unique('catamidb_genericdeployment', ['start_time_stamp', 'short_name'])

        # Deleting model 'GenericDeployment'
        db.delete_table('catamidb_genericdeployment')
