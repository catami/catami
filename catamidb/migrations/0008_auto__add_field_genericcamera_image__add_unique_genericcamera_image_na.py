...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GenericImage', fields ['date_time', 'camera']
        db.delete_unique('catamidb_genericimage', ['date_time', 'camera_id'])

        # Adding field 'GenericCamera.image'
        db.add_column('catamidb_genericcamera', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catamidb.GenericImage']),
                      keep_default=False)

        # Adding unique constraint on 'GenericCamera', fields ['image', 'name']
        db.create_unique('catamidb_genericcamera', ['image_id', 'name'])

        # Adding field 'Measurements.image'
        db.add_column('catamidb_measurements', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catamidb.GenericImage']),
                      keep_default=False)

        # Deleting field 'GenericImage.camera'
        db.delete_column('catamidb_genericimage', 'camera_id')

        # Deleting field 'GenericImage.measurements'
        db.delete_column('catamidb_genericimage', 'measurements_id')

        # Adding unique constraint on 'GenericImage', fields ['date_time', 'deployment']
        db.create_unique('catamidb_genericimage', ['date_time', 'deployment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'GenericImage', fields ['date_time', 'deployment']
        db.delete_unique('catamidb_genericimage', ['date_time', 'deployment_id'])

        # Removing unique constraint on 'GenericCamera', fields ['image', 'name']
        db.delete_unique('catamidb_genericcamera', ['image_id', 'name'])

        # Deleting field 'GenericCamera.image'
        db.delete_column('catamidb_genericcamera', 'image_id')

        # Deleting field 'Measurements.image'
        db.delete_column('catamidb_measurements', 'image_id')

        # Adding field 'GenericImage.camera'
        db.add_column('catamidb_genericimage', 'camera',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catamidb.GenericCamera']),
                      keep_default=False)
        ...
        # Adding unique constraint on 'GenericImage', fields ['date_time', 'camera']
        db.create_unique('catamidb_genericimage', ['date_time', 'camera_id'])
