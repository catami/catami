...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measurements.temperature'
        db.alter_column('catamidb_measurements', 'temperature', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Measurements.salinity'
        db.alter_column('catamidb_measurements', 'salinity', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Measurements.roll'
        db.alter_column('catamidb_measurements', 'roll', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Measurements.pitch'
        db.alter_column('catamidb_measurements', 'pitch', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Measurements.yaw'
        db.alter_column('catamidb_measurements', 'yaw', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Measurements.altitude'
        db.alter_column('catamidb_measurements', 'altitude', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Measurements.temperature'
        db.alter_column('catamidb_measurements', 'temperature', self.gf('django.db.models.fields.FloatField')(default=''))

        # Changing field 'Measurements.salinity'
        db.alter_column('catamidb_measurements', 'salinity', self.gf('django.db.models.fields.FloatField')(default=''))

        # Changing field 'Measurements.roll'
        db.alter_column('catamidb_measurements', 'roll', self.gf('django.db.models.fields.FloatField')(default=''))

        # Changing field 'Measurements.pitch'
        db.alter_column('catamidb_measurements', 'pitch', self.gf('django.db.models.fields.FloatField')(default=''))

        # Changing field 'Measurements.yaw'
        db.alter_column('catamidb_measurements', 'yaw', self.gf('django.db.models.fields.FloatField')(default=''))

        # Changing field 'Measurements.altitude'
        db.alter_column('catamidb_measurements', 'altitude', self.gf('django.db.models.fields.FloatField')(default=''))
